...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 style="text-transform: capitalize" class="page-title">Welcome Admin ! {{ Auth::user()->name_en }}
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="card dash-widget">
                    <div class="card-body">
                        ...
                        <div class="dash-widget-info">
                            <h3>{{\App\Models\Admin::count("id")}}</h3>
                            <span>Admin</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="card dash-widget">
                    <div class="card-body">
                        ...
                        <div class="dash-widget-info">
                            <h3>{{\App\Models\Instructor::count("id")}}</h3>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="card dash-widget">
                    <div class="card-body">
                        ...
                        <div class="dash-widget-info">
                            <h3>{{\App\Models\Student::count("id")}}</h3>
                            <span>Student</span>
                        </div>
                    </div>
                </div>
