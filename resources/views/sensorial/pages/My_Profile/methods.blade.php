...
@section('styles')
<link rel="stylesheet" href="/requirement/pages/Work7/css/bootstrap.min.css">
<link rel="stylesheet" href="/requirement/pages/Work7/css/bootstrap.min.css">
<link rel="stylesheet" href="/requirement/pages/Work7/css/all.min.css">
<link rel="stylesheet" href="/requirement/pages/Work7/css/style.css">
@endsection
                    ...
                    <div class="div-all">
                        <form action="/action_page.php" class="form___1">
                            ...
                            <p class="p2" lng-tag="Choose how many months you want to pay the course fee">Choose how
                                many months
                                you want to pay the course fee</p>
                            ...
                            <div class="div--3">
                                <input type="radio" name="pay" class="input-1" checked>
                                <label for="" class="label-1" lng-tag="Pay inside Jordan">Pay inside Jordan</label>
                                <div class="inline-div-1">
                                    <input type="radio" name="pay" class="input-2">
                                    <label for="" class="label-1" lng-tag="Pay outside Jordan">Pay outside
                                        Jordan</label>
                                </div>
                            </div>
                            ...
                            <div class="div--4">
                                ...
                                <label for="" class="label-3">Payment inside the academy premises</label>

                                <input type="radio" name="bank" class="input-3">
                                <label for="" class="label-3">E-FAWATERKOM</label>


                                <input type="radio" name="bank" class="input-3">
                                <label for="" class="label-3">bank deposit</label>
...
<script src="/requirement/pages/Work7/js/bootstrap.bundle.min.js"></script>
<script src="/requirement/pages/Work7/js/all.min.js"></script>
<script src="/requirement/pages/Work7/Script-2.js"></script>
<script src="/requirement/pages/Work7/js/index.js"></script>
<script src="/requirement/pages/Work7/js/translate.js"></script>
<script>
