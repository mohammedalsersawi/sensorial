        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                        ...
                        <form action="{{ route('thanks.premium',$course_id) }}" class="paymentWidgets" data-brands="VISA MASTER AMEX"></form>
                ...
                <div class="col-lg-4">
                    <div class="box-1">
                        ...
                        <p class="total" lng-tag="Total">Installment:</p>
                        <span class="span-2">{{ $Installments->Paid }}$</span><br>
                        <p class="total" lng-tag="Total">Count Installment:</p>
                        <span class="span-2">{{ $Installments->due_installments }}</span><br>
                        {{-- <del>${{ $totel }}</del> --}}
