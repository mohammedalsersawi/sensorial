            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="box-1">
                        ...
                        <span class="span-2">{{ $amount }}$</span><br>
                        <p class="total" lng-tag="Total">Count Installment:</p>
                        <span class="span-2">{{ $time_installment }}$</span><br>


                        {{-- <p class="total" lng-tag="Total">Total:</p> --}}
                        {{-- <span class="span-2">{{ $totel }}$</span><br>
                        <h5 class="total">installment</h5>
                        <span class="span-2"> <small>{{ $amount }}$</small> </span><br>
                        <span class="span-2"><small>{{ $totel }}$</small></span><br>
                        <del>$169.98</del> --}}
                        {{-- <form action="">
